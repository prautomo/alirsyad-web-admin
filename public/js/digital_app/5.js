...
function DashboardSuperadmin() {
  ...
  var _useState11 = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(0),
    ...
    currentLevelIdx = _useState12[0],
    setCurrentLevelIdx = _useState12[1];
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    ...
    window.axios.post("/backoffice/json/dashboard/".concat(nextApi.name), _defineProperty({}, nextApi.param, selectedId)).then(function (response) {
