...
/***/ "./resources/js/components/JasaTranscation/CustomerTransaction.js":
/*!************************************************************************!*\
  !*** ./resources/js/components/JasaTranscation/CustomerTransaction.js ***!
  \************************************************************************/
...
function JasaCustomerTransaction(_ref) {
  ...
  var _useFetch = Object(_store_useFetch__WEBPACK_IMPORTED_MODULE_2__["default"])("/customer/jasa/transaction/" + status + "/data?" + Object(_utls__WEBPACK_IMPORTED_MODULE_6__["encodeQuery"])(pageConfig)),
      data = _useFetch.data,
...
/* harmony default export */ __webpack_exports__["default"] = (JasaCustomerTransaction);
...
if (document.getElementById('jasa-transaction-list-container')) {
  ...
  react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(JasaCustomerTransaction, {
