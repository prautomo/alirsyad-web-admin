...
/***/ "./resources/js/components/JasaTranscation/TransactionRenderer.js":
/*!************************************************************************!*\
  !*** ./resources/js/components/JasaTranscation/TransactionRenderer.js ***!
  \************************************************************************/
...
var status_transaksi_const = {
  ...
  "SURVEI": "Tahap survey",
  "VENDOR_NEGO": "Negosiasi vendor",
  "VENDOR_CONFIRM_ACC": "Nego diterima vendor",
  "VENDOR_CONFIRM_DEC": "Nego ditolak vendor",
  "CUSTOMER_NEGO": "Negosiasi customer",
  "CUSTOMER_CONFIRM_ACC": "Nego diterima customer",
  "CUSTOMER_CONFIRM_DEC": "Nego ditolak customer",
  "IN_PROGRESS": "Sedang berlangsung",
  "PROGRESS_DONE": "Pekerjaan Selesai",
  "VENDOR_DONE": "Vendor selesai",
...
function TransactionRenderer(_ref) {
  ...
  function mitraAction(item, action) {
    sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
      ...
      if (result.isConfirmed) {
        window.axios.post("/mitra/jasa/updatepesanan", {
          item: item,
          action: action
        }).then(function (res) {
  ...
  function customerAction(item, action) {
    sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
      ...
      if (result.isConfirmed) {
        window.axios.post("/customer/jasa/updatepesanan", {
          item: item,
          action: action
        }).then(function (res) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, data.data.length == 0 ? "Belum Ada Pesanan" : data.data.map(function (transItem) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    }, role === "CUSTOMER" && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, "Jasa : ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
      className: "text-muted"
    }, transItem.jasa_user ? transItem.jasa_user.name : "(Belum Ditentukan)")), role === "MITRA" && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, "Customer : ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
      className: "text-muted"
    }, transItem.customer.name)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, "Waktu Pengerjaan: ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
      className: "text-muted"
    }, moment__WEBPACK_IMPORTED_MODULE_1___default()(transItem.waktu_pengerjaan).format("DD-MM-Y")))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
      className: "d-flex flex-column"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, "Total Transaksi : ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
      className: "text-muted"
    }, "Rp. ", transItem.total_transaksi ? numeral__WEBPACK_IMPORTED_MODULE_2___default()(Number(transItem.total_transaksi)).format("0,0") : "(Belum Ditentukan)")))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
      className: "d-flex flex-row"
    }, transItem.status_transaksi === "NOT_PAID" && role == "CUSTOMER" && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
      className: "d-flex flex-column"
      ...
      "class": "fa fa-money",
      "aria-hidden": "true"
    }))), transItem.status_transaksi === "CUSTOMER_NEGO" && role == "CUSTOMER" && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
      className: "d-flex flex-column"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
      classNam: "btn-group"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
      onClick: function onClick() {
        mitraAction(transItem, "CUSTOMER_TERIMA");
      },
      className: "btn btn-sm btn-primary  "
      ...
      onClick: function onClick() {
        mitraAction(transItem, "CUSTOMER_TOLAK");
      },
      className: "btn btn-sm btn-danger  "
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("i", {
      "class": "fa fa-close",
      "aria-hidden": "true"
    }), "  \xA0Tolak "))), transItem.status_transaksi === "VENDOR_NEGO" && role == "MITRA" && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
      className: "d-flex flex-column"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
      classNam: "btn-group"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
      ...
      "class": "fa fa-close",
      "aria-hidden": "true"
    }), "  \xA0Tolak "))), transItem.status_transaksi === "CUSTOMER_CONFIRM_ACC" && role == "MITRA" && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
      className: "d-flex flex-column"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
      classNam: "btn-group"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
      onClick: function onClick() {
        mitraAction(transItem, "PROCESS");
      },
      className: "btn btn-sm btn-primary  "
    }, "  ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("i", {
      "class": "fa fa-send",
      "aria-hidden": "true"
    }), " \xA0Kerjakan  "))), transItem.status_transaksi === "IN_PROGRESS" && role == "MITRA" && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
      className: "d-flex flex-column"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
      classNam: "btn-group"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
      onClick: function onClick() {
        mitraAction(transItem, "DONE");
      },
      className: "btn btn-sm btn-primary  "
    }, "  ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("i", {
      "class": "fa fa-send",
