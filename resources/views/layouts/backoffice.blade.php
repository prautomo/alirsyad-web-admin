...
<body>
    <!-- Sidenav -->
    @include('layouts.partials.backoffice.navbar')
  <!-- Main content -->
  <div class="main-content" id="panel">
    <!-- Topnav -->
    <nav class="navbar navbar-top navbar-expand navbar-dark bg-merah border-bottom">
                ...
                <div class="list-group list-group-flush">
                  <a href="#!" class="list-group-item list-group-item-action">
                    <div class="row align-items-center">
                      <div class="col-auto">
                        <!-- Avatar -->
                        <img alt="Image placeholder" src="{{ asset('backoffice/assets/img/theme/team-1.jpg') }}" class="avatar rounded-circle">
                      </div>
                      <div class="col ml--2">
                        <div class="d-flex justify-content-between align-items-center">
                          <div>
                            <h4 class="mb-0 text-sm">Rizky Bayu</h4>
                          </div>
                  ...
                  <a href="#!" class="list-group-item list-group-item-action">
                    <div class="row align-items-center">
                      <div class="col-auto">
                        <!-- Avatar -->
                        <img alt="Image placeholder" src="{{ asset('backoffice/assets/img/theme/team-2.jpg') }}" class="avatar rounded-circle">
                      </div>
                      <div class="col ml--2">
                        <div class="d-flex justify-content-between align-items-center">
                          <div>
                  ...
                  <a href="#!" class="list-group-item list-group-item-action">
                    <div class="row align-items-center">
                      <div class="col-auto">
                        <!-- Avatar -->
                        <img alt="Image placeholder" src="{{ asset('backoffice/assets/img/bayu2.jpg') }}" class="avatar rounded-circle">
                      </div>
                      <div class="col ml--2">
                        <div class="d-flex justify-content-between align-items-center">
                          <div>
          ...
          <ul class="navbar-nav align-items-center  ml-auto ml-md-0 ">
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu  dropdown-menu-right ">
                ...
                <form id="logout-form" action="{{ route('backoffice-logout') }}" method="POST" class="d-none">
                    @csrf
                </form>
              </div>
            </li>
    ...
    <!-- Header -->
    <!-- Header -->
    <div class="header bg-merah pb-6">
      <div class="container-fluid">
  ...
  <script src="{{ asset('backoffice/assets/vendor/bootstrap/dist/js/bootstrap.bundle.min.js') }}"></script>
