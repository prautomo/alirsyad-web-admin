  ...
  @parent
    <div class="row align-items-center py-4">
        ...
        <div class="col-lg-6 col-5 text-right">
            <a href="{{ route('backoffice::payment-methods.create') }}" class="btn btn-sm btn-neutral">New</a>
    ...
    <div class="card">
      ...
      <div class="table-responsive">
            <x-datatable>
                ...
                <th data-data="pg_gateway">@lang("Payment Gateway")</th>
                <th data-data="pg_type">@lang("PG Type")</th>
                <th data-data="pg_payment_method">@lang("PG Method")</th>
