...
@section('header')
    ...
    <div class="d-flex align-items-center">
        <form class="form-inline mr-sm-3 search-main" id="search-main">
            <div class="form-group mb-0">
                <div class="input-group input-group-alternative input-group-merge search-bar-filter">
                    ...
                    <input class="form-control" id="search-dt-table" placeholder="Cari Nama, Mata Pelajaran, Modul, Jenjang Pendidikan, Tingkat, Semester" type="text">
                </div>
            </div>
        </form>
        ...
        <div style="margin-left: auto;">
            <a href="{{ route('backoffice::videos.create') }}" class="btn btn-md btn-primary">
    ...
    <div class="card bg-transparent">
      ...
      <div class="">
            <x-datatable.table :customSearch="__(1)">
                ...
                <th data-data="modul">@lang("Modul")</th>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $.ajax({
            type:'GET',
            url:'/backoffice/videos/filter-col',
