  ...
  @parent
    <div class="row align-items-center py-4">
        ...
        <div class="col-lg-6 col-5 text-right">
            <a href="{{ route('backoffice::promos.create') }}" class="btn btn-sm btn-neutral">New</a>
    ...
    <div class="card">
      ...
      <div class="table-responsive">
            <x-datatable>
                ...
                <th data-data="code">@lang("Code")</th>
                <th data-data="name">@lang("Name")</th>
                <th data-data="mitra">@lang("Mitra")</th>
                <th data-data="start_date">@lang("Start Date")</th>
                <th data-data="end_date">@lang("End Date")</th>
