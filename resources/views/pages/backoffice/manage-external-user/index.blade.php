...
@section('header')
    ...
    <div class="d-flex align-items-center">
        ...
        <div style="margin-left: auto;">
            <a href="{{ route('backoffice::manage-external-users.create') }}" class="btn btn-md btn-primary">
...
<div class="row">
    ...
    <div class="card bg-transparent">
      <!-- tble -->
      <div class="">
            <x-datatable.table :filterCol="__('3,2,1')" :isMultiple="__('0,0,0')" :customSearch="__(1)">
                {{--
