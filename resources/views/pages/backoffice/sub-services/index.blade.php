...
@section('title', __("Sub Service ".$service->name))
...
@section('header')
  @parent
    <div class="row align-items-center py-4">
        ...
        @can('subservice-create')
        <div class="col-lg-6 col-5 text-right">
            <a href="{{ route('backoffice::sub-services.create', ['serviceId' => $serviceId]) }}" class="btn btn-sm btn-neutral">New</a>
    ...
    <div class="card">
      ...
      <div class="table-responsive">
            <x-datatable>
                ...
                --}}
                <th data-data="show-img">@lang("Icon")</th>
