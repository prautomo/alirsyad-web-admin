...
@section('title', __("History Saldo ".$user->name))
...
@section('header')
  @parent
    <div class="row align-items-center py-4">
        ...
        @can('history-saldo-create')
        <div class="col-lg-6 col-5 text-right">
            <a href="{{ route('backoffice::history-saldo.create', ['userId' => $userId]) }}" class="btn btn-sm btn-neutral">New</a>
