...
@section('header')
    ...
    <div class="d-flex align-items-center">
        <form class="form-inline mr-sm-3 search-main" id="search-main">
            <div class="form-group mb-0">
                <div class="input-group input-group-alternative input-group-merge search-bar-filter">
                    ...
                    <input class="form-control" id="search-dt-table" placeholder="Cari Jenjang Pendidikan" type="text">
                </div>
            </div>
        </form>
        ...
        <div style="margin-left: auto;">
            <a href="{{ route('backoffice::kelas.create') }}" class="btn btn-md btn-primary">
...
<div class="row">
    ...
    @endif
        <div class="card bg-transparent">
            <!-- table -->
            <div class="">
                <x-datatable.table :filterCol="__('2,1')" :isMultiple="__('0,0')" :customSearch="__(1)">
                    {{--
