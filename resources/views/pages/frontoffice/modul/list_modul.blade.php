				...
				<div class="card">
					<div class="card-body" style="height: 500px; overflow: auto;">
                        @forelse($moduls as $modul)
                            <div class="wrap-kelas row mt-3 ml-1 mr-1" style="padding: 15px 15px 15px 15px !important; cursor: pointer;" onclick="location.href='{{ route('app.modul.detail', @$modul->slug) }}.html';">
