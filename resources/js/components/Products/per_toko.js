...
function ProductTokoContainer({ initialPageConfig, tokoDetail }) {
        ...
        <div style={{ marginTop: '100px' }} className="d-flex flex-column align-items-start">
            {
                <>
                    <div className="mb-4 mt-4 prod-page-header">
                        <h3>Produk Di Toko {tokoDetail.name}</h3>
                    </div>
...
export default ProductTokoContainer;
export {
    Pagination,
    ProductItems
}
...
if (document.getElementById('products-container-toko')) {
    ...
    ReactDOM.render(<ProductTokoContainer initialPageConfig={initialPageConfig} tokoDetail={tokoDetail} />, container);
}
